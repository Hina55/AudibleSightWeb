...
<head>
  ...
  <title>Sign up | Audible Sight</title>
        ...
        <div class="row justify-content-center" >
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
            ...
            <form action="" method="post" role="form" class="myform" autocomplete="off" style="padding-bottom: 15%; padding-top: 12%;">
              <label style="margin-bottom: 3%;color: red;"><span> <?php echo $error;  ?> </span></label>
                <div class="form-group">
                  <label for="fullname">Full Name</label>
                  <input type="text" name="fullname" class="form-control" id="fullname" data-rule="minlen:4" required/>
                  <label class="text-danger" data-rule="minlen:4"><?php echo $fullnameErr;?></label>
                  <div class="validate"></div>
                </div>
                <div class="form-group">
                  <label for="username">Username</label>
                  <input type="text" name="username" class="form-control" id="username" data-rule="minlen:4" required/>
                  <label class="text-danger" data-rule="minlen:4"><?php echo $usernameErr;?></label>
                  <div class="validate"></div>
                </div>
                <div class="form-group">
                  <label for="email">Your Email</label>
                  <input type="email" class="form-control" name="email" id="email" data-rule="email" required />
                  <label class="text-danger" data-rule="email"><?php echo $emailErr;?></label>
                  <div class="validate"></div>
                </div>
                <div class="form-group">
                  <label for="contact">Contact</label>
                  <input type="text" name="contact" class="form-control" id="contact" data-rule="minlen:4" required />
                  <label class="text-danger" data-rule="minlen:4"><?php echo $contactErr;?></label>
                  <div class="validate"></div>
                </div>
                 <div class="form-group">
                  <label for="address">Address</label>
                  <input type="text" name="address" class="form-control" id="address" data-rule="minlen:4" required/>
                  <div class="validate"></div>
                </div>
              ...
              <div class="form-group">
                ...
                <label class="text-danger" data-rule="minlen:4"><?php echo $passwordErr;?></label>
                <div class="validate"></div>
              </div>
             <div class="form-group col-xs-4">
              <button style="background-color: #17a6a3;color:#ffffff;" class="btn"  name="submit" type="submit" value=" Login ">Sign up</button><br><br>
              <h5 class="text-danger"><?php echo $msgErr;?></h5> 
