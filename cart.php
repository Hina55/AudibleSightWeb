...
<head>
  ...
  <title>Cart | Audible Sight</title>
...
?>
      ...
      <div class="container" style="padding-top: 6%; padding-bottom: 5%">
        ...
        <div class="col-12">
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead style="background: #ffffff; color: black;">
                        <tr>
                            <th scope="col"> </th>
...
<?php
    ...
    {
      ?>
      <div class="jumbotron" style="margin-right: 8%; margin-left: 8%;">
