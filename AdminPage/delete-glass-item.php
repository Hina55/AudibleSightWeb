  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="deleteglass.php" method="POST">
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Delete Your Glass Item Here. </h3>
          <hr>
...
$sql = "SELECT * FROM glass ORDER BY G_ID";
...
<div class="table-responsive">
  ...
  <tbody>
    <tr>
      <td> <input name="checkbox[]" type="checkbox" value="<?php echo $row['G_ID']; ?>"/> </td>
  ...
  <?php } ?>
    ...
    <br>
          ...
          <center><button type="submit" id="submit" name="delete" value="Delete" class="btn btn-danger pull-right"> DELETE</button>    </center>
      </div>
  ...
  <?php } ?>
          ...
          <div class="card-footer small text-muted">Last Updated at <?php $filename = 'delete-glass-item.php';
