  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> Add New Glass Item Here </h3>

          <div class="form-group">
            <input type="text" class="form-control" id="name" name="name" placeholder="Your glass name" required="">
          </div>     

          <div class="form-group">
            <input type="text" class="form-control" id="price" name="price" placeholder="Your glass Price (Rs.)" required="">
          </div>

          <div class="form-group">
            <input type="text" class="form-control" id="description" name="description" placeholder="Your glass Description" required="">
          </div>

          <div class="form-group">
            <!--<input type="file" class="form-control" id="images_path" name="images_path" placeholder="Your glass Image Path [images/<filename>.<extention>]" required="">-->
              
        <input type="file" name="file" class="form-control" placeholder="Browse image" required="" style="height: 5%;">
             
      <!--<input type="file" class="form-control"  name="images_path" id="images_path" style="height: 4%;"> -->
          </div>

          <div class="form-group">
         <center> <input type="submit"  name="submit" class="btn btn-primary pull-right" value="Upload">  </center> 
      </div>
        </form>
          ...
          <div class="card-footer small text-muted">Last Updated at <?php $filename = 'add-glass-item.php';
